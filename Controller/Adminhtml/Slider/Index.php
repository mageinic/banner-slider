...
class Index extends Action implements HttpGetActionInterface
{
     ...
     * @see _isAllowed()
     */
    public const ADMIN_RESOURCE = 'MageINIC_BannerSlider::manage_slider';
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('MageINIC_BannerSlider::mageinic_slider');
        $resultPage->addBreadcrumb(__('MageINIC'), __('MageINIC'));
