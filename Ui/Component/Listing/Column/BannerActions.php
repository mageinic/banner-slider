...
/**
 * BannerSlider Class BannerActions
 */
class BannerActions extends Column
{
     ...
     * Url path
     */
    public const URL_PATH_EDIT = 'bannerslider/banner/edit';
    public const URL_PATH_DELETE = 'bannerslider/banner/delete';
        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as & $item) {
                if (isset($item['banner_id'])) {
                    $name = $this->escaper->create()->escapeHtml($item['name']);
